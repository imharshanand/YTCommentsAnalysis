...
def get_authenticated_service(args):
    ...
    with open("youtube-v3-discoverydocument.json", "r", errors='ignore') as f:
        doc = f.read()
...
if __name__ == "__main__":
  ...
  try:
    ...
    with io.open('commentscraperfile.csv', 'w',encoding="utf-8") as csvfile:
...
with io.open("commentscraperfile.csv","r", encoding="utf-8") as csvfile:
